...
const uint16_t PROGMEM test_combo2[] = {KC_M, KC_COMM, COMBO_END};
const uint16_t PROGMEM test_combo3[] = {KC_R, KC_T, COMBO_END};
const uint16_t PROGMEM test_combo4[] = {KC_Y, KC_U, COMBO_END};
const uint16_t PROGMEM test_combo5[] = {KC_V, KC_B, COMBO_END};
const uint16_t PROGMEM test_combo6[] = {U_PST, KC_DEL, COMBO_END};
const uint16_t PROGMEM test_combo7[] = {KC_H, LSFT_T(KC_J), COMBO_END};
const uint16_t PROGMEM test_combo8[] = {KC_WH_D, KC_BTN1, COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
    COMBO(test_combo1, KC_RALT),
    COMBO(test_combo2, KC_RALT),
    COMBO(test_combo3, KC_TAB),
    COMBO(test_combo4, KC_DEL),
    COMBO(test_combo5, TO(NAV)),
    COMBO(test_combo6, TO(BASE)),
    COMBO(test_combo7, KC_BTN1),
    COMBO(test_combo8, TO(BASE))
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,---------------------------------------------------------------------------------------------------.                                         ,-------------------------------------------------------------------------------------------------.
                    KC_Q,               KC_W,               KC_E,               KC_R,               KC_T,                                                       KC_Y,               KC_U,               KC_I,               KC_O,      LT(NAV, KC_P),
  //|-------------------+-------------------+-------------------+-------------------+-------------------|                                         |-----------------+-------------------+-------------------+-------------------+-------------------|
            LGUI_T(KC_A),       LALT_T(KC_S),       LCTL_T(KC_D),       LSFT_T(KC_F),               KC_G,                                                       KC_H,       LSFT_T(KC_J),       LCTL_T(KC_K),       LALT_T(KC_L),    LGUI_T(KC_COLN), 
  //|-------------------+-------------------+-------------------+-------------------+-------------------|                                         |-----------------+-------------------+-------------------+-------------------+-------------------|
                    KC_Z,       ALGR_T(KC_X),               KC_C,               KC_V,               KC_B,                                                       KC_N,               KC_M,            KC_COMM,     ALGR_T(KC_DOT),   LT(NAV, KC_SLSH),
  //|-------------------+-------------------+-------------------+-------------------+-------------------|                                         |-----------------+-------------------+-------------------+-------------------+-------------------|
  ...
  //|-------------------+-------------------+-------------------+-------------------+-------------------|                                         |-----------------+-------------------+-------------------+-------------------+-------------------|
                   RESET,               U_NA,            KC_MSTP,            KC_MPLY,            KC_MUTE,                                                      U_UND,              U_CUT,              U_CPY,              U_PST,              U_RDO,
  //|-------------------+-------------------+-------------------+-------------------+-------------------|                                         |-----------------+-------------------+-------------------+-------------------+-------------------|
                                                                              KC_ESC,            KC_BSPC,              KC_ENT,                U_NA,             U_NA,               U_NA
  //                                                            |-------------------+-------------------+--------------------+--------------------+-----------------+-------------------|
  ),
